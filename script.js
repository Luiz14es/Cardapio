...
const cartCount = document.getElementById("cart-cound");
  ...
  cart.forEach((item) => {
    ...
    <div class="flex items-center justify-between">
      <div>
        ...
        <button class="remove-cart-from-btn" data-name="${
          item.name
        }">Remover</button>
...
checkoutBtn.addEventListener("click", function () {
  const isOpen = chekRestaurantOpen();
